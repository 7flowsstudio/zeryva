  ...
  return (
    <div className={`container ${s.heroCont}`}>
      ...
      <p>
        ...
        робить ставку на науковий підхід, власні розробки та практичні польові
        дослідження. Це допомогло швидко здобути довіру фермерів і
        агропідприємств по всій Україні.
      </p>
      ...
      <p>
        ...
        поєднує інновації, науковий підхід та практичний досвід, щоб забезпечити
        аграріїв дієвими, безпечними та економічно вигідними рішеннями для
        оптимізації врожайності та збереження родючості ґрунтів.
      </p>
      ...
      <p>
        ...
        продукт «Зерива» створений з урахуванням потреб конкретної культури, її
        фази розвитку та можливих стресових факторів. Завдяки цьому аграрії
