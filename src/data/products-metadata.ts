...
export const productsMetadata: ProductMetadataItem[] = [
	{
		...
		title: "РизоСтарт",
		shortDescription: "Інокулянт для бобових культур (сухий) РизоСтарт",
	...
	},
	{
		...
		title: "РизоСтарт",
		shortDescription: "Інокулянт для бобових культур (рідкий) РизоСтарт",
	...
	},
	{
		...
		title: "Арія",
		shortDescription: "Фітосанітарний контроль посівів Арія",
	...
	},
	{
		...
		title: "РизоГумат",
		shortDescription: "Антистресант та стимулятор росту рослин РизоГумат",
	...
	},
	{
		...
		title: "Віолон",
		shortDescription: "Антистресант та стимулятор росту рослин Віолон",
	...
	},
	{
		...
		title: "Ризофос",
		shortDescription: "Фосфатмобілізуючий інокулянт Ризофос",
	...
	},
	{
		...
		title: "Фунгіблок",
		shortDescription: "Фітосанітарний контроль посівів Фунгіблок",
	...
	},
	{
		...
		title: "ДеструMag",
		shortDescription: "Деструктор для розкладу рослинних решток ДеструMag",
	...
	},
	{
		...
		title: "Zeryva Бор + Молібден",
		shortDescription: "Мікродобриво та стимулятор росту Zeryva Бор + Молібден",
		image: "/products/ayqlgpvohnfqguoqny7j.webp",
	},
	{
		id: "QaVcFWvc02Qnbm5Z0qwz",
		slug: "kompleksne-mikrodobryvo-zeryva-multymiks",
		title: "Zeryva Мультимікс",
		shortDescription: "Комплексне мікродобриво Zeryva Мультимікс",
	...
	},
	{
		...
		title: "Zeryva Цинк",
		shortDescription: "Мікродобриво та стимулятор росту Zeryva Цинк",
		image: "/products/j00dkevks5ge3qwxl9rg.webp",
	},
	{
		id: "PfYvWruYbHFPH0gAeEgn",
		slug: "mikrodobryvo-ta-stymuliator-rostu-zeryva-kaltsii",
		title: "Zeryva Кальцій",
		shortDescription: "Мікродобриво та стимулятор росту Zeryva Кальцій",
	...
	},
	{
		...
		title: "Ліпротенс",
		shortDescription: "Поверхнево-активна речовина (ПАР) Ліпротенс",
	...
	},
	{
		...
		title: "Глеон",
		shortDescription: "Препарат для підвищення родючості ґрунту Глеон",
